...
<head><meta http-equiv="Content-Type" content="text/html; charset=shift_jis">
  ...
  <link rel="shortcut icon" href="<?php echo base_url(); ?>img/avatars/pixabay.png">
  <title> Pixabay</title>
  <!-- Icons -->
...
<!-- <img rel="shortcut icon" src="<?php echo base_url();?>img/avatars/pixabay.png" class="img-avatar" > -->

<!-- <link class="navbar-brand" href="<?php echo base_url(); ?>img/avatars/pixabay.png"> -->
 <a class="navbar-brand" href="<?php echo base_url();?>img/avatars/pixabay.png"> </a> 
    ...
    <ul class="nav navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown ">
        ...
        <a class="nav-link nav-pill avatar avatar-img-margin" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
          ...
          <span class="profile-name"><strong></strong></span>
    ...
    <div class="sidebar">
      ...
      <nav class="sidebar-nav">
       ...
       <li class="nav-item">
           ...
           <!--  <a class="nav-link" href="<?php echo base_url(); ?>Contacts"><i class="icon-people"></i> </a> -->

           <a class="nav-link" href="<?php echo base_url(); ?>My_Profile"><i class="fa fa-user"></i>My_Profile </a>
...
<!-- 
 ...
 -->
          ...
          <li class="nav-item">
            ...
            <a class="nav-link" href="<?php echo base_url(); ?>Pixabay"><i class="icon-people"></i> Search</a>
        ...
        <!-- <li class="nav-item">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            ...
            <a class="nav-link" href="<?php echo base_url(); ?>Registration"><i class="icon-people"></i> Registration</a>
