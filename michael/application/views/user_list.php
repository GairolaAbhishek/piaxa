                   ...
                   if ($data=='No') {
                    ...
                    for ($i=0; $i <sizeof($data); $i++) { 
                      if (empty($data[$i]['image'])) {
                       ...
                       // print_r($data[$i]['image']);exit();
                        $img = '';
                      }
                      else
                      {
                        $img = '<a class="tabel-data-profile-img" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                <img src="'.base_url().'/img/avatars/'.$data[$i]['image'].'" class="img-avatar" alt="admin@bootstrapmaster.com">
                                  </a>';
                      }
                      $d = $i+1;
                      ...
                      echo ' <tr id="tr" class="tr'.$data[$i]['id'].'">
                              ...
                              <td>'.$data[$i]['email'].'</td>
                              <td>'.$img.'</td>
                              <td style="text-align:right;"> <a class="btn btn-info action-btn edit" data-id='.$data[$i]['id'].' data-user='.$data[$i]['name'].' data-email='.$data[$i]['email'].' data-pass='.$data[$i]['password'].' data-pic='.$data[$i]['image'].' data href="#edit_form"  data-toggle="modal" >
      ...
      <div class="modal-content">
       <div class="modal-header">
        ...
        <div class="modal-body">
          <div class="form-group">
           <label class="control-label">User Name</label>
            <input type="text" placeholder="User name" id="edituser"  required class="form-control" name="name">
         ...
         <label for="ccnumber">Profile Image</label>
          <br>
           <input type="file" class="form-control" id="editimg"  name="image[]"  placeholder="Profile Image" accept="Image/*">
         </div>
        </div>
        <div class="modal-footer">
         <button type="submit" class="btn btn-danger btn-sm check">Submit</button>
